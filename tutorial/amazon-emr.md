...
also cannot end in numbers \cite{hid-sp18-521-prereq}. In order to create
...
selections, click 'Create bucket' \cite{hid-sp18-521-s3bucket}.

![image](images/S3_create_bucket.png)
...
connect to the EC2 instances created by EMR \cite{hid-sp18-521-ec2keypair}.

![image](images/EMRkey.png)
...
cluster \cite{hid-sp18-521-emrlaunch}.

![image](images/emr_gen_config.png)
...
workloads \cite{hid-sp18-521-emrlaunch}.

![image](images/emr_software_config.png)

![image](images/emr_security.png)
...
tutorial \cite{hid-sp18-521-emrprocess}.

![image](images/emr_cluster_create.png)

![image](images/emr_cluster_steps.png)

![image](images/emr_cluster_steps2.png)
...
this tutorial \cite{hid-sp18-521-emrreset}.

![image](images/emr_terminate.png)

![image](images/s3_delete_bucket.png)
